...
![Afficher plus de détails](./assets/consulter_details_auteurs.gif)
...
![Recherche sans guillemets](./assets/consulter_recherche_sans_guillemets.gif)

**Exemple avec guillemets :**

![Recherche avec guillemets](./assets/consulter_recherche_avec_guillemets.gif)
