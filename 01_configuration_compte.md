...
![Inscription](./assets/configuration_inscription.gif)
...
![Configurer l'IdHAL](./assets/configuration_idhal.jpeg)

Une fois votre IdHAL correctement créé, vous devriez avoir ceci :

![Exemple IdHAL OK](./assets/configuration_idhalok.png)
...
![Affiliation LINEACT](./assets/configuration_affiliation.gif)
...
![Configuration finale](./assets/configuration_final.png)
